...
const X64_SETUP =
  "https://github.com/Arunstha21/Handy/releases/download/v0.9.6/Handy_0.9.6_x64-setup.exe";
const ARM64_SETUP =
  "https://github.com/Arunstha21/Handy/releases/download/v0.9.6/Handy_0.9.6_arm64-setup.exe";
...
const manifest = {
  ...
  platforms: {
    ...
    "windows-x86_64-msi": {
      url: "https://github.com/Arunstha21/Handy/releases/download/v0.9.6/Handy_0.9.6_x64_en-US.msi",
    },
    "windows-aarch64-nsis": { url: ARM64_SETUP, signature: "…" },
    "darwin-aarch64": {
      url: "https://github.com/Arunstha21/Handy/releases/download/v0.9.6/Handy_aarch64.app.tar.gz",
    },
  },
};
